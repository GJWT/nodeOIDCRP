...
describe('Test Client', function() {
    ...
    it('Test construct accesstoken request', function() { 
        ...
        */
        client.stateDb.set('ABCDE', State.toJSON({auth_request: AuthorizationRequest.toJSON({redirect_uri:'https://example.com/cli/authz_cb', state: 'state'}), auth_response: AuthorizationResponse.toJSON({refresh_token:'refresh_with_me', access_token:'access'})}));
        let reqArgs = {};
